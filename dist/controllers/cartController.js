...
var addToCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, productId, userId, emailId, totalPrice, productExits, userExits, crateCart, cartFind, updateCart;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          _req$body = req.body, productId = _req$body.productId, userId = _req$body.userId, emailId = _req$body.emailId, totalPrice = _req$body.totalPrice;
          if (productId) {
            _context.next = 6;
            break;
          }
          throw new _index.BadRequestError("Please Pass ProjectId");
        case 6:
          _context.next = 8;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          throw (0, _index.NotFoundError)("Something Went Wrong");
        case 4:
          if (!userId) {
            _context2.next = 12;
            break;
        ...
        case 7:
          ...
          throw (0, _index.NotFoundError)("User Not Found");
        case 10:
          _context2.next = 20;
          break;
        case 12:
        ...
        case 15:
          ...
          throw (0, _index.NotFoundError)("Cart Not Found");
        case 18:
          if (!(findCartId.isCheckout == true)) {
            _context2.next = 20;
            break;
          }
        ...
        case 20:
          ...
          return _models.cartModel.aggregate([{
            ...
            $project: _defineProperty(_defineProperty({
              _id: 1,
              productId: 1,
              userId: 1,
              totalPrice: 1,
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          throw (0, _index.NotFoundError)("please enter valid data");
        case 4:
          _context3.next = 6;
          return _models.cartModel.findOne({
            _id: cartId,
        ...
        case 11:
          ...
          throw (0, _index.NotFoundError)("Product not found.");
        case 14:
        ...
        case 23:
          ...
          throw (0, _index.NotFoundError)("Something went wrong while remove cart");
        case 26:
          return _context3.abrupt("return", _service["default"].sendResponse(res, 200, "Item Removed", data));
        case 29:
          _context3.prev = 29;
