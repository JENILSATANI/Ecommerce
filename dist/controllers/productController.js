...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var productDetail, upload;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          productDetail = new _models.productModel();
          console.log("🚀 ~ addProduct ~ productDetail:", productDetail);
          upload = _service["default"].uploadImage("productImage", productDetail._id, "productId");
          ...
          upload(req, res, /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err) {
              var productExist, _req$body, categoryId, tagId, categoryIdExists, tagIdExists;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 10:
                    _req$body = req.body, categoryId = _req$body.categoryId, tagId = _req$body.tagId;
                    _context.next = 13;
                    return _models.categoryModel.findById(categoryId);
                  case 13:
                    categoryIdExists = _context.sent;
                    if (categoryIdExists) {
                      _context.next = 16;
                      break;
                    }
                  ...
                  case 16:
                    _context.next = 18;
                    return _models.tagModel.findById(tagId);
                  case 18:
                    tagIdExists = _context.sent;
                    if (tagIdExists) {
                      _context.next = 21;
                      break;
                    }
                  ...
                  case 28:
                    ...
                    _context.next = 31;
                    return _models.imageModel.insertMany(req.images.map(function (image) {
                      return _objectSpread({
                        productId: productDetail._id
                      }, image);
                    }));
                  case 31:
                    return _context.abrupt("return", _service["default"].sendResponse(res, 200, "Data saved"));
                  case 34:
                    _context.prev = 34;
        ...
        case 8:
          ...
          console.log("🚀 ~ addProduct ~ error:", _context2.t0);
  ...
  return function addProduct(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var getProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var productId, productData, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          throw (0, _index.NotFoundError)("Tag not found.");
        case 5:
          _context3.next = 7;
          return _models.productModel.findOne({
            _id: productId
        ...
        case 7:
          ...
          throw new _index.BadRequestError("tag Already exist");
        case 10:
          _context3.next = 12;
          return _models.productModel.aggregate([{
            $match: {
              _id: new _mongoose["default"].Types.ObjectId(productId)
            }
          }, {
            $lookup: {
              from: "categories",
        ...
        case 12:
          ...
          return _context3.abrupt("return", _service["default"].sendResponse(res, 200, "Get Product Successfully", data));
        case 17:
          _context3.prev = 17;
  ...
  return function getProduct(_x5, _x6, _x7) {
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 16:
          data = _context4.sent;
          return _context4.abrupt("return", _service["default"].sendResponse(res, 200, "product Updated Successfully", data));
        case 20:
          _context4.prev = 20;
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          productDelete = _context5.sent;
          if (productDelete) {
            _context5.next = 6;
            break;
          }
          throw new _index.BadRequestError("Product Already Deleted");
        case 6:
          productDelete.isDeleted = true;
          productDelete.save();
          return _context5.abrupt("return", _service["default"].sendResponse(res, 200, "product Delete Successfully"));
        case 11:
          _context5.prev = 11;
